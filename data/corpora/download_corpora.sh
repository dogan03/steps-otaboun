...
# English EWT
# train
curl https://raw.githubusercontent.com/UniversalDependencies/UD_Ottoman_Turkish-BOUN/master/ota_boun-ud-train.conllu -o ota_boun/ota_boun-ud-train.conllu
python delexicalize_corpus.py ota_boun/ota_boun-ud-train.conllu > ota_boun/ota_boun-ud-train.delex.conllu

curl https://raw.githubusercontent.com/UniversalDependencies/UD_Ottoman_Turkish-BOUN/master/ota_boun-ud-test.conllu -o ota_boun/ota_boun-ud-test.conllu
python delexicalize_corpus.py ota_boun/ota_boun-ud-test.conllu > ota_boun/ota_boun-ud-test.delex.conllu
# dev
